...
export default function HomePage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400">{t('home.error')}: {error}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: 'var(--background)', color: 'var(--foreground)' }}>
      {/* Hero Section */}
      <section className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] flex items-center overflow-x-hidden"
        ...
        <div className="absolute inset-x-0 bottom-24 sm:bottom-28 z-10 hidden lg:block">
          <div className="container mx-auto px-4 text-white">
            <div className="max-w-xl bg-black/40 backdrop-blur-md rounded-xl p-4 sm:p-6 shadow-lg">
              ...
              <p className="text-base sm:text-xl mb-4 sm:mb-6">{t('home.hero.subtitle')}</p>
              <Link href="/events">
      ...
      <section
        className="py-6 sm:py-10 md:py-16 lg:py-20 overflow-x-hidden"
        style={{
      ...
      >
        <div className="container mx-auto px-4">
          <div className="mb-8 sm:mb-12 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-2">{t('home.featured.title')}</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-center">
            <div className="mb-4 sm:mb-0">
              <h2 className="text-2xl sm:text-3xl font-bold mb-2">{t('home.upcoming.title')}</h2>
            ...
            <Link href="/events">
              <span className="text-indigo-600 hover:text-indigo-800 font-medium flex items-center">
                {t('home.upcoming.viewAll')} <FaArrowRight className="ml-1 text-sm" />
              </span>
            </Link>
          </div>
      ...
      <section className="hidden lg:block py-12 xl:py-16 bg-indigo-600 text-white overflow-x-hidden">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg xl:text-xl mb-6 xl:mb-8 max-w-2xl mx-auto leading-relaxed">
            {t('home.cta.subtitle')}
          </p>
          <Link href="/events">
            <span className="inline-block bg-white text-indigo-600 font-bold px-6 xl:px-8 py-2.5 xl:py-3 rounded-lg hover:bg-gray-100 transition duration-300 text-base xl:text-lg shadow-lg hover:shadow-xl transform hover:scale-105">
              {t('home.cta.button')}
            </span>
          </Link>
        </div>
    ...
    >
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex items-center mb-2 text-sm sm:text-base opacity-80" style={{ color: 'var(--foreground)' }}>
          ...
          <span className="truncate">{formatEventDateLocale(event.eventDate, event.eventTimezone, locale)}</span>
        </div>
