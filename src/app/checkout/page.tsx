    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="rounded-xl p-6 shadow" style={{ background: 'var(--surface)', borderColor: 'var(--border)', borderWidth: 1 }}>
        ...
        <div className="flex gap-3">
          ...
          >
            {loading ? 'Processing...' : `Pay ${total.toFixed(2)} ${' '} ${getCurrencySymbol(checkoutData.country || 'Finland')}`}
          </button>
        </div>
      </div>
    </form>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl p-6 shadow" style={{ background: 'var(--surface)', borderColor: 'var(--border)', borderWidth: 1 }}>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="text-sm opacity-80">Ticket Type</div>
                    <div className="text-base font-medium">{checkoutData.ticketName}</div>
                  </div>
                  <div>
                    <div className="text-sm opacity-80">Quantity</div>
                    <div className="text-base font-medium">{checkoutData.quantity} ticket{checkoutData.quantity > 1 ? 's' : ''}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl p-6 shadow" style={{ background: 'var(--surface)', borderColor: 'var(--border)', borderWidth: 1 }}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="opacity-80">VAT ({checkoutData.vat}%)</span>
