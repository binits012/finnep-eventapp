          ...
          <div className="mb-8 p-6 rounded-lg border" style={{ 
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="opacity-80" style={{ color: 'var(--foreground)' }}>There was an error submitting your application. Please try again.</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="rounded-2xl p-8 shadow-lg border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm opacity-70 mt-1" style={{ color: 'var(--foreground)' }}>PDF, DOC, or DOCX files only (max 10MB)</p>
              </div>
